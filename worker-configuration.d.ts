/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 23839618938cb3a52f1174ad848ebf33)
...
interface __BaseEnv_Env {
	...
	LLM_KEY: string;
	Chat: DurableObjectNamespace<import("./realtime/index").Chat>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./realtime/index");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KINDE_CLIENT_ID" | "KINDE_CLIENT_SECRET" | "KINDE_ISSUER_URL" | "KINDE_SITE_URL" | "KINDE_POST_LOGOUT_REDIRECT_URL" | "KINDE_POST_LOGIN_REDIRECT_URL" | "KINDE_DOMAIN" | "KINDE_MANAGEMENT_CLIENT_ID" | "KINDE_MANAGEMENT_CLIENT_SECRET" | "ARCJET_KEY" | "ARCJET_ENV" | "DATABASE_URL" | "UPLOADTHING_TOKEN" | "LLM_KEY">> {}
}
